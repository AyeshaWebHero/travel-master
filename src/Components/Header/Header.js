            ...
            <div className="header" >
                <Navbar className="navbarr" bg="transparent" expand="lg">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <Link to="/login"><Button style={{fontWeight:'bold',backgroundColor: '#F9A51A',width: '108px',height: '44px',borderRadius: '7px',padding: '12px 29px', fontFamily:'Geneva, Tahoma'}}>Log In</Button></Link>
                    ...
                    <div class="row travel-place-cards">
                            <div style={{color: 'white'}} class="col-xl-3 col-md-4 col-sm-12">
                                <h1 style={{fontWeight:'bold', fontSize: 25, color:'red', fontFamily: 'Montserrat'}}>Bangladesh</h1>
